<div class="nav-outer clearfix" style="margin-left: 90px">
    ...
    <nav class="main-menu navbar-expand-md navbar-light">
        ...
        <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent" style="margin-left: 90px">
            ...
            <ul class="social-box clearfix">
                ...
                <li>
                    @if (auth('web')->check() ||
                            auth('admin')->check() ||
                            auth('doctor')->check() ||
                            auth('ray_employee')->check() ||
                            auth('laboratorie_employee')->check() ||
                            auth('patient')->check())
                        {{-- <span class="nav-link" > --}}
                                ...
                                {{ auth('web')->user()->name ??
                                    (auth('admin')->user()->name ??
                                        (auth('doctor')->user()->name ??
                                            (auth('ray_employee')->user()->name ??
                                                (auth('laboratorie_employee')->user()->name ?? auth('patient')->user()->name)))) }}
                        </a>
                        {{-- </span> --}}
                    @else
