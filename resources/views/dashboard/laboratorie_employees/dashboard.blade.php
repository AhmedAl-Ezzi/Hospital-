                    ...
                    <div class="row align-items-center mb-2">
                        <div class="col">
                            <h2 class="h5 page-title">
                                <span style="font-size: 26px">     لوحة تحكم المختبر</span>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            <span class="badge badge-pill badge-danger" style="font-size: 14px">
                                                +{{ App\Models\Laboratorie::where('case', 0)->count() }}
                                            </span>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            <span class="badge badge-pill badge-success" style="font-size: 14px">
                                                +{{ App\Models\Laboratorie::where('case', 1)->count() }}
                                            </span>
                                        </div>
                                        <div class="col-auto">
