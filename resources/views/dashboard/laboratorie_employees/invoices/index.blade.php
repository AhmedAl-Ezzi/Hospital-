                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($laboratories as $laboratorie)
                                                <tr>
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($laboratorie->created_at)->format('Y-m-d   h:i A') }}</td>
                                                    <td>{{ $laboratorie->Patient->name }}</td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item" href="#" data-toggle="modal"
                                                                    data-target="#add_diagnosis{{ $laboratorie->id }}">
                                                        ...
                                                        @include('dashboard.laboratorie_employees.invoices.add_diagnosis')
