            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <div class="row">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            ...
                                            <p class="small text-muted mb-0">جميع الفواتير</p>
                        ...
                        <!-- الفواتير تحت الإجراء -->
                        <div class="col-md-3 mb-4">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <span class="h5 mb-0">تحت الإجراء</span>
                                            <p class="small text-muted mb-0">قيد المعالجة</p>
                                            <span class="badge badge-pill badge-danger" style="font-size:14px">
                                                +{{ $invoices_no_done }}
                                            </span>
                                        </div>
                                        <div class="col-auto">
                                            <i class="bi bi-hourglass-split display-4 text-danger"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- الفواتير في المراجعة -->
                        <div class="col-md-3 mb-4">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <span class="h5 mb-0">في المراجعة</span>
                                            <p class="small text-muted mb-0">بانتظار الاعتماد</p>
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <span class="h5 mb-0">مكتملة</span>
                                            <p class="small text-muted mb-0">تم إنهاؤها</p>
                                ...
                                <div class="card-body" data-simplebar
                                    ...
                                    <div class="pb-3 timeline-item item-warning">
                                        <div class="pl-5">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col"><img
                                                        src="{{ asset('dashboard') }}/assets/products/p1.jpg"
                                                        alt="..." class="img-fluid rounded"></div>
                                                <div class="col"><img
                                                        src="{{ asset('dashboard') }}/assets/products/p2.jpg"
                                                        alt="..." class="img-fluid rounded"></div>
                                                <div class="col"><img
                                                        src="{{ asset('dashboard') }}/assets/products/p3.jpg"
                                                        alt="..." class="img-fluid rounded"></div>
                                                <div class="col"><img
                                                        src="{{ asset('dashboard') }}/assets/products/p4.jpg"
                                                        alt="..." class="img-fluid rounded"></div>
                                            </div>
                                                ...
                                                <li>
                                                    <a href="#!" class="avatar avatar-sm">
                                                        <img alt="..." class="avatar-img rounded-circle"
                                                            src="{{ asset('dashboard') }}/assets/avatars/face-1.jpg">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#!" class="avatar avatar-sm">
                                                        <img alt="..." class="avatar-img rounded-circle"
                                                            src="{{ asset('dashboard') }}/assets/avatars/face-4.jpg">
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#!" class="avatar avatar-sm">
                                                        <img alt="..." class="avatar-img rounded-circle"
                                                            src="{{ asset('dashboard') }}/assets/avatars/face-3.jpg">
                                                    </a>
                                                </li>
                                            </ul>
                                            <p class="small text-muted">Front-End Development <span
