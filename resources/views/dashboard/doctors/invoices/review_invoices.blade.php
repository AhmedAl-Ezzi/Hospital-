            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    ...
                    <h2 class="mb-2 page-title">الـكـشوفات/
                        <span style="font-size: 26px">تحت المراجعة</span>
                    </h2>
                    <br>
                    <div class="row my-4">
                        <!-- Small table -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            $reviewDate = \App\Models\Diagnostic::where(
                                                                'invoice_id',
                                                                $invoice->id,
                                                            )
                                                        ...
                                                        @endphp
                                                        @if ($reviewDate)
                                                            {{ \Carbon\Carbon::parse($reviewDate)->format('A') == 'AM' ? 'ص' : 'م' }}
                                                            {{ \Carbon\Carbon::parse($reviewDate)->format('h:i : d-m-Y  ') }}
                                                        @else
                                                            --
                                                        @endif
                                                    </td>
