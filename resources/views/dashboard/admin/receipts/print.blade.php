...
<div class="modal fade" id="print{{ $receipt->id }}" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">

            <div class="modal-body" id="printArea{{ $receipt->id }}">
                <div class="print-invoice">
                    ...
                    <div class="print-info">
                        <div>
                            <p><strong>تاريخ الإصدار:</strong> {{ $receipt->date }}</p>
                        </div>
                        <div>
                            <p><strong>اسم المريض:</strong> {{ $receipt->patients->name }}</p>
                        </div>
                    </div>
            ...
            <div class="mb-3 text-center">
                <button class="btn btn-warning"
                        onclick="printReceipt('printArea{{ $receipt->id }}')">
