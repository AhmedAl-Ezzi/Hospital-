            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="row align-items-center mb-2">
                        <div class="col">
                            <h2 class="h5 page-title" style="font-size: 26px">لوحة تحكم الادمن</h2>
                        </div>
                        <div class="col-auto">
                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <span class="h5 mb-0"> عدد الأطباء</span>
                                            <p class="small text-muted mb-0">الأطباء</p>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <span class="h5 mb-0">عدد المرضى</span>
                                            <p class="small text-muted mb-0">المرضى</p>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <span class="h5 mb-0">عدد الأقسام</span>
                                            <p class="small text-muted mb-0">الأقسام</p>
                                            <span class="badge badge-pill badge-success" style="font-size:14px">
                                                +{{ $sections }}
                                            </span>
                                        </div>
                                        <div class="col-auto">
                                            <i class="bi bi-hospital display-4 text-success"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
