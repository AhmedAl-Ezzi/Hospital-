          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="#dashboard" data-toggle="collapse" aria-expanded="false" class=" nav-link">
                ...
                <span class="ml-3 item-text">Notifications</span><span class="sr-only">(current)</span>
              </a>
            </li>
          </ul>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
                <li class="nav-item">
                  <a class="nav-link pl-3" href="#"><span class="ml-1 item-text">  Notifications</span>
                  </a>
                </li>
                <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="tables">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./table_datatables.html"><span class="ml-1 item-text"> Notifications</span></a>
                </li>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="collapse list-unstyled pl-4 w-100" id="charts">
                ...
                <li class="nav-item">
                  <a class="nav-link pl-3" href="./chart-chartjs.html"><span class="ml-1 item-text">ApexCharts </span></a>
                </li>
                <li class="nav-item">
